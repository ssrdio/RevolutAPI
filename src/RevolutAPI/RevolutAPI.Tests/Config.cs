...
namespace RevolutAPI.Tests
{
    public class Config
    {
        public static readonly string ENDPOINT = "https://sandbox-b2b.revolut.com/api";
        ...
        public static readonly string MERCHANTAPIKEY = "";
        public static readonly string MERCHANTAPIVERSION = "";
        public static readonly string MERCHANTENDPOINT = "https://sandbox-merchant.revolut.com"; 
